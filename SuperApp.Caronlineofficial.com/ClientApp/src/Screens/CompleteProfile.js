...
export default function CompleteProfile() {
    const [input, setinput] = useState({ fullName: "", job: "", gender: "", birthDay: "", email: "", password: "", confirmPassword: "", invitedUser: "" });
        ...
        <div className="row " style={{ height: "90vh" }}>
            <div className="col-10 col-md-8 mx-auto row" style={{ maxHeight: "35vh" }}>
                <div className="w-100 p-4 back-ground mt-5 row">
                    ...
                    <div className="col-12 mt-3">
                        <select name="job" id="job" className=' form-select form-control'>
                            ...
                            <option>مغازه دار (آرایشگر، سوپرمارکت، وسایل الکترونیکی و ...)</option>
                            <option>مهندس / (رایانه ، راه و ساختمان ، پزشکی ، صنعت و...)</option>
                    ...
                    <div className="col-12 mt-3">
                        <select name="gender" id="gender" className=' form-select form-control' onChange={(e) => setinput({ ...input, gender: e.target.value })}>
                    ...
                    <div className="col-12 mt-3">
                        ...
                        }} show={datePickerModal} round='x2' inputClass="p-2 form-control back-ground disabled " inputAttributes={{ placeholder: "تاریخ تولد خود را وارد نمایید" }} />
                    </div>
                    <div className="col-12 mt-3">
                        <input
                            type="text"
                    ...
                    <div className="col-12 mt-3">
                        <div className={`btn btn-success btn-block w-100 p-2 `} onClick={() => {
                            api.CompleteProfile(({ data }) => { }, input)
                        }}>تکمیل حساب کاربری</div>
                    </div>
                </div>
            </div>
        </div>
